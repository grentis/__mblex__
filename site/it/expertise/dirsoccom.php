...
<html>
	<head>
		<title>Diritto societario e commerciale | Studio Legale Bicecci & Partners</title>
						...
						<div class="section">
							<aside>
								<div class="aside">
									<nav>
										<ul class="nav">
											<li class="first"><a href="dirbanfin.php">Diritto bancario e finanziario</a></li>
											<li><a href="priequi.php">M&A - Private Equity</a></li>
											<li class="current"><a href="dirsoccom.php">Diritto societario e commerciale</a></li>
