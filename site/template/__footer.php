	...
	<div class="footer">
		<nav>
			<ul class="nav">
				...
				<li class="privacy <?php echo ($CURRENT_PAGE == 'privacy')?'current':'' ?>"><a href="<?php echo createPATH($CURRENT_LEVEL) ?>privacy.php" onclick="window.open('<?php echo createPATH($CURRENT_LEVEL) ?>privacy.php?popup=true','privacy','top=30,left=30,width=400,height=500,status=0,menubar=0,toolbar=0,resizable=0,scrollbars=1'); return false;" title="<?php echo $KEY[$LANGUAGE]['PRIVACY'] ?>"><span><?php echo strtoupper($KEY[$LANGUAGE]['PRIVACY']) ?></span></a></li>
				<li class="disclaimer last <?php echo ($CURRENT_PAGE == 'disclaimer')?'current':'' ?>"><a href="<?php echo createPATH($CURRENT_LEVEL) ?>disclaimer.php" onclick="window.open('<?php echo createPATH($CURRENT_LEVEL) ?>disclaimer.php?popup=true','disclaimer','top=30,left=30,width=400,height=500,status=0,menubar=0,resizable=0,toolbar=0,scrollbars=1'); return false;" title="<?php echo $KEY[$LANGUAGE]['DISCLAIMER'] ?>"><span><?php echo strtoupper($KEY[$LANGUAGE]['DISCLAIMER']) ?></span></a></li>
			</ul>
		</nav>
