	...
	<div class="footer">
		<nav>
			<ul class="nav">
				...
				<li class="privacy <?php echo ($CURRENT_PAGE == 'privacy')?'current':'' ?>"><a href="<?php echo createPATH($CURRENT_LEVEL) ?>privacy.php" title="<?php echo $KEY[$LANGUAGE]['PRIVACY'] ?>"><span><?php echo strtoupper($KEY[$LANGUAGE]['PRIVACY']) ?></span></a></li>
				<li class="disclaimer last <?php echo ($CURRENT_PAGE == 'disclaimer')?'current':'' ?>"><a href="<?php echo createPATH($CURRENT_LEVEL) ?>disclaimer.php" title="<?php echo $KEY[$LANGUAGE]['DISCLAIMER'] ?>"><span><?php echo strtoupper($KEY[$LANGUAGE]['DISCLAIMER']) ?></span></a></li>
			</ul>
		</nav>
